...
// returns a score 0-4 based on password strength
...
// remove invalid and valid styles from inputs
...
if (loginForm) {
    ...
    loginForm.addEventListener('submit', function(e) {
        ...
        // success — save session and go to feed
...
if (registerForm) {
    ...
    // update strength bar as the user types
    if (passwordInput) {
